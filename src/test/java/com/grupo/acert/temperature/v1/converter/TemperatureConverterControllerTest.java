...
class TemperatureConverterControllerTest {
    ...
    void findById_MustReturnSuccess() throws Exception {
        ...
        mockMvc.perform(get("/v1/converter/" + savedTemperature.getId()))
                ...
                .andExpect(jsonPath("valueFahrenheit").value(savedTemperature.getValueFahrenheit()))
    ...
    void findAllPageable_MustReturnSuccess() throws Exception {
        ...
        mockMvc.perform(get("/v1/converter?page=0&size=3"))
                ...
                .andExpect(jsonPath("content[0].valueFahrenheit").value(savedTemperature.getValueFahrenheit()))
                ...
                .andExpect(jsonPath("content[1].valueFahrenheit").value(savedTemperature2.getValueFahrenheit()))
                ...
                .andExpect(jsonPath("content[2].valueFahrenheit").value(savedTemperature3.getValueFahrenheit()))
